	...
	public class BibliotecaPersonal2 {
	
	private Libro[] libros;
	private int num_libros;
	
	public BibliotecaPersonal2(int max_libros) {
	...
	System.out.println("Error: Esta indicando una posición que se encuentra vacia.");
	}
	...
	BibliotecaPersonal2 miBiblioteca;
	miBiblioteca = new BibliotecaPersonal2(100);
